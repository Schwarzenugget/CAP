 ...
 */
float *WeightIH[NUMHID];	//Pesos entre neurones d'entrada i ocultes
float *WeightHO[NUMOUT];	//Pesos entre neurones ocultes i de sortida

float rando() 
{
	return ((float)(rand()/((RAND_MAX+1)*1.0)));
}
